const _0x2f35f5=_0x2758;function _0x2c88(){const _0x44c00f=['2048674NNAwlg','154yQhZeM','9KyXqwu','2023903hKfrTt','482390tfndue','4973568fqyvUm','833465tFPham','EdselPaculanang','1981809BigMel','exit','4236560YBfUUq','1zwvylp','18vyQUdR'];_0x2c88=function(){return _0x44c00f;};return _0x2c88();}function _0x2758(_0x5e4241,_0x19b561){const _0x2c883a=_0x2c88();return _0x2758=function(_0x27585e,_0x597337){_0x27585e=_0x27585e-0x67;let _0x14bc8c=_0x2c883a[_0x27585e];return _0x14bc8c;},_0x2758(_0x5e4241,_0x19b561);}(function(_0x1489b5,_0x29538f){const _0x396e6f=_0x2758,_0x5358a6=_0x1489b5();while(!![]){try{const _0x1e78d1=parseInt(_0x396e6f(0x6f))/0x1*(parseInt(_0x396e6f(0x71))/0x2)+parseInt(_0x396e6f(0x6c))/0x3+-parseInt(_0x396e6f(0x69))/0x4+-parseInt(_0x396e6f(0x6a))/0x5*(parseInt(_0x396e6f(0x70))/0x6)+-parseInt(_0x396e6f(0x67))/0x7+parseInt(_0x396e6f(0x6e))/0x8*(parseInt(_0x396e6f(0x73))/0x9)+-parseInt(_0x396e6f(0x68))/0xa*(-parseInt(_0x396e6f(0x72))/0xb);if(_0x1e78d1===_0x29538f)break;else _0x5358a6['push'](_0x5358a6['shift']());}catch(_0x30d739){_0x5358a6['push'](_0x5358a6['shift']());}}}(_0x2c88,0xd14a8));const owner=process['env']['REPL_OWNER'];if(owner!==_0x2f35f5(0x6b)){throw'\0a██████╗\0a██╔════╝\0a█████╗░░\0a██╔══╝░░\0a██║░░░░░\0a╚═╝░░░░░\0a░█████╗░\0a██╔══██╗\0a██║░░██║\0a██║░░██║\0a╚█████╔╝\0a░╚════╝░\0a██████╗░\0a██╔══██╗\0a██████╔╝\0a██╔══██╗\0a██║░░██║\0a╚═╝░░╚═╝\0a██╗░░██╗\0a██║░██╔╝\0a█████═╝░\0a██╔═██╗░\0a██║░╚██╗\0a╚═╝░░╚═╝\0a\0a\0a██████╗░\0a██╔══██╗\0a██████╔╝\0a██╔═══╝░\0a██║░░░░░\0a╚═╝░░░░░\0a░█████╗░\0a██╔══██╗\0a███████║\0a██╔══██║\0a██║░░██║\0a╚═╝░░╚═╝\0a\20\0a\0a██████╗░\0a██╔══██╗\0a██████╦╝\0a██╔══██╗\0a██████╦╝\0a╚═════╝░\0a░█████╗░\0a██╔══██╗\0a██║░░██║\0a██║░░██║\0a╚█████╔╝\0a░╚════╝░\0a██████╗░\0a██╔══██╗\0a██████╦╝\0a██╔══██╗\0a██████╦╝\0a╚═════╝░\0a░█████╗░\0a██╔══██╗\0a██║░░██║\0a██║░░██║\0a╚█████╔╝\0a░╚════╝░\20';process[_0x2f35f5(0x6d)](0x1);}
...
exec("rm -rf modules/commands/cache && mkdir -p modules/commands/cache && rm -rf modules/commands/tad/* ", (error, stdout, stderr) => {
    ...
    console.log(chalk.bold.hex("#00ffff")("Prince (MPNrandomly) ❯ ") + chalk.hex("#00ffff")("fixed by Edsel Paculanang"))
});
...
console.log(chalk.bold.hex("#00ffff").bold("[ Princ (Paculanang) ] » ") + chalk.bold.hex("#00ffff").bold("Initializing variables..."));
...
cron.schedule('0 0 6 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Daily Update:\nGoodmorning mga pogi..\nBy Edsel Paculanang", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Manila"
