...
module.exports.handleEvent = function({ api, event, args, Threads }) {
  ...
  if ((event.body.toLowerCase() == "Pogi") || (event.body.toLowerCase() == "pogi")) {
    return api.sendMessage("pogi cge na ligawan muna admin ko haha", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "edsel") || (event.body.toLowerCase() == "Edsel")) {
    return api.sendMessage("Yes? ano po yun", threadID);
  };

  if ((event.body.toLowerCase() == "Edsel") || (event.body.toLowerCase() == "Edsel Paculanang")) {
  ...
  if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "sino ba owner mo?")) {
    return api.sendMessage("️si Edsel Paculanang", threadID);
  };
