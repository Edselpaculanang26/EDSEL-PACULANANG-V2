...
=== [ 𝗔𝗗𝗠𝗜𝗡 𝗕𝗢𝗧 ] ===
  ❯ 𝗥𝗘𝗔𝗟 𝗡𝗔𝗠𝗘 : 𝐄𝐝𝐬𝐞𝐥 𝐏𝐚𝐜𝐮𝐥𝐚𝐧𝐚𝐧𝐠
  ❯ 𝗥𝗣 𝗡𝗔𝗠𝗘 : 𝐄𝐝𝐬𝐞𝐥
  ❯ 𝗛𝗘𝗜𝗚𝗛𝗧 : 𝐬𝐞𝐜𝐫𝐞𝐭
  ❯ 𝗗𝗔𝗧𝗘 𝗢𝗙 𝗕𝗜𝗥𝗧𝗛 : 
  ❯ 𝗭𝗢𝗗𝗜𝗔𝗖 : 𝐂𝐚𝐧𝐜𝐞𝐫 
  ❯ 𝗪𝗘𝗜𝗚𝗛𝗧 : 𝐒𝐞𝐜𝐫𝐞𝐭
  ❯ 𝗙𝗕 𝗔𝗖𝗖𝗢𝗨𝗡𝗧 : https://www.facebook.com/edsel.garganerapaculanang.56
...
responseType: "stream"
        ...
        case "3": {
          const axios = require('axios');
       api.unsendMessage(handleReply.messageID);
    return api.sendMessage({body: `𝐀𝐝𝐦𝐢𝐧 𝐒𝐨𝐜𝐢𝐚𝐥 𝐌𝐞𝐝𝐢𝐚 :\n—𝐄𝐝𝐬𝐞𝐥 : https://www.facebook.com/edsel.garganerapaculanang.56\n—Kylee : https://www.facebook.com/edsel.garganerapaculanang.56`, attachment: (await global.nodemodule["axios"]({
url: (await global.nodemodule["axios"]('https://api.zeidbot.site/images/phongcanhimg')).data.data,
method: "GET",
responseType: "stream"
})).data
